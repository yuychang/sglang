...
def is_kimi_k3_moe_preroute_fp8_available() -> bool:
    ...
    return (
        importlib.util.find_spec("flydsl") is not None and get_gfx_runtime() == "gfx950"
    )
...
def _tri_cooperative_preactivated_launcher(
    ...
    return build_kimi_k3_multitoken_tri_projection_module(
        ...
        cu_count=envs.SGLANG_ROCM_K3_PREROUTE_COOP_CU.get(),
        waves_per_block=envs.SGLANG_ROCM_K3_PREROUTE_COOP_WPB.get(),
        waves_per_eu=envs.SGLANG_ROCM_K3_PREROUTE_COOP_WPE.get(),
        weight_cache_modifier=envs.SGLANG_ROCM_K3_PREROUTE_COOP_WCM.get(),
