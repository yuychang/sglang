...
class Envs:
    ...
    # 1-stage custom all-reduce. Default covers decode M in {1, 2, 4}.
    # M=8 is 112 KiB: forcing the 1-stage residual kernel lost 2.17 us/layer
    # versus 2-stage AR + agg HAS_ADD, so MAX_TOKENS stays 4.
    SGLANG_ROCM_K3_AR_RESIDUAL = EnvBool(True)
    SGLANG_ROCM_K3_AR_RESIDUAL_MAX_TOKENS = EnvInt(4)
