...
<table style={{width: "100%", borderCollapse: "collapse", tableLayout: "fixed"}}>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.05)"}}>Fuse the Kimi-K2.5 MXFP4 absorbed MLA value projection with the flattened MXFP4 quantization consumed by <code>o_proj</code> on ROCm gfx95/AITER decode. Unsupported configurations and active <code>kv_b_proj</code> LoRAs use the split path.</td>
      <td style={{padding: "9px 12px", backgroundColor: "rgba(255,255,255,0.02)"}}>`true`</td>
    </tr>
    <tr>
